...
import xyz.xcyd.wechat.offiaccount.remind.RemindService;
...
public class MsgHandler extends AbstractHandler {
    ...
    public WxMpXmlOutMessage handle(WxMpXmlMessage wxMessage,
        ...
        // 处理提醒服务公众号的消息
        if(WxMpConfigStorageHolder.get().equals(p.getPurpose().getRemind())){
            content = remindService.apply(weixinService, wxMessage);
        }
